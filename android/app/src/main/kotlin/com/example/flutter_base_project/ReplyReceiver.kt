...
import com.example.flutter_base_project.data.ChatRepository
import com.example.flutter_base_project.data.DefaultChatRepository
...
class ReplyReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val results = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT_WATCH) {
            RemoteInput.getResultsFromIntent(intent) ?: return
        } else {
