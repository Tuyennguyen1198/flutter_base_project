...
package com.example.flutter_base_project.data
...
import com.example.flutter_base_project.BubbleActivity
import com.example.flutter_base_project.MainActivity
import com.example.flutter_base_project.R
import com.example.flutter_base_project.ReplyReceiver
...
class NotificationHelper(private val context: Context) {
    ...
    fun setUpNotificationChannels() {
        if (if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                notificationManager.getNotificationChannel(CHANNEL_NEW_MESSAGES) == null
            } else {
